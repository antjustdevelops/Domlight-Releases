...
$form.ClientSize=[Drawing.Size]::new(620,300)
$form.MinimumSize=[Drawing.Size]::new(640,340)
$form.Font=[Drawing.Font]::new('Segoe UI',10)
$form.FormBorderStyle='FixedDialog'
$form.MaximizeBox=$false

$chk=New-Object Windows.Forms.CheckBox;$chk.Text='Использовать прокси';$chk.Location=[Drawing.Point]::new(24,22);$chk.Size=[Drawing.Size]::new(220,28);$form.Controls.Add($chk)
function Add-Field([string]$label,[int]$y,[bool]$password=$false){
    $l=New-Object Windows.Forms.Label;$l.Text=$label;$l.Location=[Drawing.Point]::new(24,$y);$l.Size=[Drawing.Size]::new(145,25);$form.Controls.Add($l)
    $t=New-Object Windows.Forms.TextBox;$t.Location=[Drawing.Point]::new(170,$y-2);$t.Size=[Drawing.Size]::new(420,28);$t.UseSystemPasswordChar=$password;$form.Controls.Add($t);return $t
}
$txtUrl=Add-Field 'URL прокси' 72
$txtUser=Add-Field 'Пользователь' 116
$txtPass=Add-Field 'Пароль' 160 $true
$hint=New-Object Windows.Forms.Label;$hint.Text='Пример: http://127.0.0.1:8080  или  http://host:port';$hint.Location=[Drawing.Point]::new(170,194);$hint.Size=[Drawing.Size]::new(420,24);$hint.ForeColor=[Drawing.Color]::DimGray;$form.Controls.Add($hint)
$btnSave=New-Object Windows.Forms.Button;$btnSave.Text='Сохранить';$btnSave.Location=[Drawing.Point]::new(324,236);$btnSave.Size=[Drawing.Size]::new(125,38);$form.Controls.Add($btnSave)
$btnCancel=New-Object Windows.Forms.Button;$btnCancel.Text='Отмена';$btnCancel.Location=[Drawing.Point]::new(465,236);$btnCancel.Size=[Drawing.Size]::new(125,38);$form.Controls.Add($btnCancel)
...
$btnSave.Add_Click({
    try{
        ...
        if($chk.Checked){
            $uri=$null
            if(-not [Uri]::TryCreate($url,[UriKind]::Absolute,[ref]$uri)){throw 'Некорректный URL прокси.'}
            if($uri.Scheme -notin @('http','https')){throw 'Поддерживается прокси http:// или https://.'}
        }
...
if($SmokeTest){Write-Output 'SMOKE_OK ConnectionSettings';$form.Dispose();exit 0}
